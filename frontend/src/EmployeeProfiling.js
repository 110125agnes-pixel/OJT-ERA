...
function EmployeeProfiling() {
  ...
  const [newEmployee, setNewEmployee] = useState({
    caseNo: '', // auto-generated by backend
    hospitalNo: '',
    lastname: '',
    firstname: '',
    middlename: '',
  ...
  // Auto-calculate age from birthdate — returns full years only (e.g. 25)
        ...
        <div className="form-grid">
          <div className="form-field">
            ...
            <input
              ...
              placeholder="Auto-generated (e.g. C2026-00001)"
              readOnly
          ...
          <div className="form-field">
            ...
            <input
              ...
              onChange={(e) => {
                ...
                setNewEmployee({ ...newEmployee, birthdate: bd, age: calcAge(bd) });
              }}
              required
            />
          </div>
          <div className="form-field">
            ...
            <input
              ...
              readOnly
              placeholder="Set birthdate above"
